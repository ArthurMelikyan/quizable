                                            ...
                                            <div class="form-group  align-items-center" :class="{'d-md-flex' : questionNavigation.class}" v-show="questionNavigation.file_type.file">
                                                ...
                                                <div class="block-3 d-flex align-items-center ">
                                                    <div class="custom-file w-auto">
                                                        ...
                                                        <label class="custom-file-label overflow-hidden" for="file">{{ trans('__quiz__.Choose file') }}</label>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div v-if="questionType === 'file'"
                                                        ...
                                                        <div class="block-3 d-flex align-items-center mb-3 position-relative answer">
                                                            <div class="custom-file w-auto ">
                                                                ...
                                                                <label class="custom-file-label answer-image-label" :data-browse="'quiz.Choose file'" for="customFile">{{ trans('__quiz__.Choose file') }}</label>
                                                            </div>
...
<!--                                                                    maxlength="250" :placeholder="'Enter an answer choice'" v-model="data[index]['short_answer']">-->
<!--                                                        </div>-->
<!--                                                    </div>-->

                                                    <div v-if="element.type === 'text'" v-for="answer in element.answers"
                                                         class="block-3 d-flex align-items-center mb-3">
                                                        <div class="form-group mb-0 position-relative answer flex-grow-1 d-flex align-items-center overflow-hidden">
                                                            <input type="text"  class="form-control pr-5" maxlength="250" :placeholder="trans('__quiz__.Enter an answer choice')"
                                                                   v-model="answer.short_answer" >
                                                        </div>
                                                    </div>
    ...
    methods: {
        ...
        async questionUpdate(url, method) {
            ...
            await axios({
                ...
                this.showSweet({successmsg:  window.trans.__quiz__['Question updated successfully'] }, 'success');
            }).catch(error => {
                this.valid = false;
                console.log(error)
            })
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        axios.delete(`/${window.urlprefix}/quizable/quiz/${this.quiz_id}/questions/${questionId}`).then(resp => {
                            this.getAllQuizQuestions();
                            this.showSweet({successmsg: window.trans.__quiz__['Question deleted successfully'] }, 'success');
                        }).catch(error => {
                            console.log(error)
                        })
                    } else {
