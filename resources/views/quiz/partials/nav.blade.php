<div class="left-menu">
    ...
    <div id="simple-bar" class="simple-bar">
        <ul class="menu-nav" id="menu-nav">
            <li class="menu-item">
                <a href="{{ route('quizable.dashboard') }}" class="menu-link  @if (request()->routeIs('quizable.dashboard')) active @endif">
                    <span class="svg-icon">
            ...
            <li class="menu-item">
                <a href="{{ route('quizable.quiz.index') }}" class="menu-link @if (request()->routeIs('quizable.quiz.*')) active @endif">
                    <span class="svg-icon">
