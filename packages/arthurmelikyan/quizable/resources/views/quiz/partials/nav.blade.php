<nav id="sidebar" aria-label="Main Navigation">
    ...
    <div class="bg-header-dark">
        <div class="content-header bg-white-10">
            <a class="link-fx font-w600 font-size-lg text-white" href="{{route('quizable.quizes.index')}}">
            ...
            <li class="nav-main-item open">
                ...
                <ul class="nav-main-submenu">
                    <li class="nav-main-item">
                        <a class="nav-main-link @if(request()->routeIs('quizable.quizes.index')) active @endif "  href="{{route('quizable.quizes.index')}}">
