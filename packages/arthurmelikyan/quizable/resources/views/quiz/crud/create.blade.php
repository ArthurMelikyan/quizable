                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" value="{{old('title')}}" class="form-control" id="title" name="title" placeholder="Enter quiz title..">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="number" value="{{old('time_limit')}}" min="0" max="1440" class="form-control text-center" value="" id="time_limit" name="time_limit" placeholder="Enter duration...">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
